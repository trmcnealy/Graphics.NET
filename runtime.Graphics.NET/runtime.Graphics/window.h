...
namespace forge
{
    ...
    public:
         ...
         */
        FGAPI Window(const int pWidth, const int pHeight, const char* pTitle, const Window* pWindow = nullptr, const bool invisible = false);
        ...
        /**
           ...
           when in multiview mode.
         */
        FGAPI void draw(const int pRows, const int pCols, const int pIndex, const Image& pImage, const char* pTitle = nullptr, const bool pKeepAspectRatio = true);
        ...
        /**
           ...
           when in multiview mode.
         */
        FGAPI void draw(const int pRows, const int pCols, const int pIndex, const Chart& pChart, const char* pTitle = nullptr);
