...
namespace forge
{
    namespace common
    {
        ...
        public:
            FgError(const char* const pFuncName, const char* const pFileName, const int pLineNumber, const char* const pMessage, forge::ErrorCode pErrCode);

            FgError(std::string pFuncName, std::string pFileName, const int pLineNumber, std::string pMessage, forge::ErrorCode pErrCode);
        ...
        public:
            TypeError(const char* const pFuncName, const char* const pFileName, const int pLine, const int pIndex, const forge::dtype pType);
        ...
        public:
            ArgumentError(const char* const pFuncName, const char* const pFileName, const int pLine, const int pIndex, const char* const pExpectString);
...
#define ARG_ASSERT(INDEX, COND)                                                                               \
    ...
    {                                                                                                         \
        if((COND) == false)                                                                                   \
        {                                                                                                     \
            throw forge::common::ArgumentError(__PRETTY_FUNCTION__, __FG_FILENAME__, __LINE__, INDEX, #COND); \
        }                                                                                                     \
    } while(0)
...
#define TYPE_ERROR(INDEX, type)                                                                      \
    do                                                                                               \
    {                                                                                                \
        throw forge::common::TypeError(__PRETTY_FUNCTION__, __FG_FILENAME__, __LINE__, INDEX, type); \
    } while(0)

#define FG_ERROR(MSG, ERR_TYPE)                                                                      \
    do                                                                                               \
    {                                                                                                \
        throw forge::common::FgError(__PRETTY_FUNCTION__, __FG_FILENAME__, __LINE__, MSG, ERR_TYPE); \
    } while(0)
...
#define CATCHALL \
    catch(...) { return forge::common::processException(); }
