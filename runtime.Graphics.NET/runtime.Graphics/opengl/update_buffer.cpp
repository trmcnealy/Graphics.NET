...
#include <runtime.Graphics/update_buffer.h>
#include <runtime.Graphics/opengl/gl_helpers.hpp>

fg_err fg_update_vertex_buffer(const unsigned pBufferId, const size_type pBufferSize, const void* pBufferData)
{
    try
    {
...
fg_err fg_update_pixel_buffer(const unsigned pBufferId, const size_type pBufferSize, const void* pBufferData)
{
    try
    {
...
namespace forge
{
    void updateVertexBuffer(const unsigned pBufferId, const size_type pBufferSize, const void* pBufferData)
    {
    ...
    void updatePixelBuffer(const unsigned pBufferId, const size_type pBufferSize, const void* pBufferData)
    {
