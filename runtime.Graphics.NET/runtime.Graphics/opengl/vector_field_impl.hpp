...
namespace forge
{
    namespace opengl
    {
        ...
        public:
            vector_field_impl(const uint32_t pNumPoints, const forge::dtype pDataType, const int pDimension = 3);
            ~vector_field_impl();

            uint32_t  directions();
            size_type directionsSize() const;
        ...
        public:
            vector_field2d_impl(const uint32_t pNumPoints, const forge::dtype pDataType) : vector_field_impl(pNumPoints, pDataType, 2) {}
        };
