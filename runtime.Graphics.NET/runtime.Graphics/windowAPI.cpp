...
fg_err fg_create_window(fg_window* pWindow, const int pWidth, const int pHeight, const char* pTitle, const fg_window pShareWindow, const bool pInvisible)
{
    try
    {
...
fg_err fg_draw_image_to_cell(const fg_window pWindow, const int pRows, const int pCols, const int pIndex, const fg_image pImage, const char* pTitle, const bool pKeepAspectRatio)
{
    try
    {
        ARG_ASSERT(0, (pWindow != nullptr));
...
fg_err fg_draw_chart_to_cell(const fg_window pWindow, const int pRows, const int pCols, const int pIndex, const fg_chart pChart, const char* pTitle)
{
    try
    {
        ARG_ASSERT(0, (pWindow != nullptr));
