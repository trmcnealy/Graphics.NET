...
namespace forge
{
    ...
    public:
        ...
        /**
           ...
           \param[in] pZ is z-axis title label
         */
        FGAPI void setAxesTitles(const char* pX, const char* pY, const char* pZ = nullptr);
        ...
        /**
           ...
           \param[out] pZmax is z-axis maximum data value
         */
        FGAPI void getAxesLimits(float* pXmin, float* pXmax, float* pYmin, float* pYmax, float* pZmin = nullptr, float* pZmax = nullptr);
