...
namespace forge
{
    namespace wtk
    {
        ...
        private:
            ...
            const glm::mat4 findTransform(const forge::common::MatrixHashMap& pMap, const float pX, const float pY);
            ...
            void            setTransform(forge::common::MatrixHashMap& pMap, const float pX, const float pY, const glm::mat4& pMat);
        ...
        public:
            ...
            Widget(int pWidth, int pHeight, const char* pTitle, const std::unique_ptr<Widget>& pWidget, const bool invisible);
            ...
            const glm::mat4 getOrientationMatrix(const forge::common::CellIndex& pIndex);
